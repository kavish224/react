...
function App() {
    ...
    return (
        <>
            <div className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat bg-code">
                <div className="w-full">

                    <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
                        <h1 className="text-white flex flex-wrap justify-center mb-4 text-3xl">Currency Converter</h1>
                        <form
                            onSubmit={(e) => {
                                e.preventDefault();
                                convert()
                        ...
                        >
                            ...
                            <button type="submit" className="w-full bg-orange-500 text-white px-4 py-3 rounded-lg">
